...
int str2mc(const char *s)
{
    ...
    if (!strcmp(s, "1.21.4"))   return MC_1_21_WD; // Winter Drop ruleset
    if (!strcmp(s, "1.21.5"))   return MC_1_21_WD; // Winter Drop ruleset
    if (!strcmp(s, "26.1.2"))   return MC_26_1_2;
    if (!strcmp(s, "4790"))     return MC_26_1_2; // vanilla DataVersion for 26.1.2
    if (!strcmp(s, "1.21.11"))  return MC_26_1_2; // old HelixSeed compatibility token
