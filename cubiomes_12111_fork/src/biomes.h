...
{   // MC_1_X refers to the latest patch of the respective 1.X release.
    ...
    MC_1_21_1,
    MC_1_21_3,
    MC_1_21_WD, // Winter Drop / 1.21.4-era rules
    MC_1_21_11, // compatibility alias for the local 26.1.2 ruleset
    MC_26_1_2 = MC_1_21_11, // verified against PrismLauncher vanilla 26.1.2 / DataVersion 4790
    MC_1_21 = MC_1_21_WD,
    MC_NEWEST = MC_26_1_2,
};
